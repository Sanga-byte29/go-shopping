        ...
        <fieldset>
          ...
          <div class="mt-6 space-y-6">
            <div class="flex items-center gap-x-3">
              ...
              <label for="card" class="block text-sm font-medium leading-6 text-gray-900">Cash
              </label>
            </div>
            <div class="flex items-center gap-x-3">
              <Input id="card" name="payments" type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600" />
              <label htmlFor="card" class="block text-sm font-medium leading-6 text-gray-900">Card payment</label>
            </div>
